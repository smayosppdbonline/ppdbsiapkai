...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxgoJ-f2-z1jL2ujKi0zm7PS_ChTMZqHwhkYCGlgGC_G4fRpX2MMrc7YHXP8R7e07EB/exec"; 
...
const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    ...
    sambutanKepalaSekolah: "Selamat datang di website resmi PPDB SMA Yosudarso Dobo. Kami berkomitmen untuk memberikan pelayanan pendidikan terbaik bagi putra-putri Anda. Mari bergabung bersama kami untuk mencetak generasi penerus bangsa yang cerdas, berakhlak mulia, dan berprestasi.",
