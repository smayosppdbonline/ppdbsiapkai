      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Bergabunglah bersama {settings?.namaSekolah || 'SMA Yosudarso Dobo'}. Kami berkomitmen memberikan pendidikan dasar terbaik dengan fasilitas modern dan tenaga pendidik profesional.
            </motion.p>
            ...
            >
              ...
              <div className="prose prose-lg text-slate-600">
                ...
                <div className="flex items-center gap-4 mt-8">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900">{settings?.namaKepalaSekolah || 'RD. Rolland Ignatius Renwarin, S.Fils'}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Ikuti langkah-langkah mudah berikut untuk mendaftarkan putra/putri Anda di SMA Yosudarso Dobo.
            </p>
          </div>
